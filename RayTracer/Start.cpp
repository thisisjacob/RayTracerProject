...
int main() {
	...
	std::shared_ptr<Light> light = std::shared_ptr<Light>(new Light{ glm::tvec3<double>(0.0, 0.0, 1.4), 0.5 });
	std::shared_ptr<Light> newLight = std::shared_ptr<Light>(new Light{ glm::tvec3<double>(2.0, 0.0, 1.0), 0.5 });
