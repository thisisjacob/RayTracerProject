...
int main() {
	...
	dynamic_pointer_cast<IdealSpecular>(mirrorShader)->SetSpecularCoeff(glm::tvec3<double>(0.7, 0.7, 0.7));
	dynamic_pointer_cast<IdealSpecular>(mirrorShader)->SetAmbientCoeff(glm::tvec3<double>(0.0, 0.0, 0.0));
	dynamic_pointer_cast<IdealSpecular>(mirrorShader)->SetDiffuseCoeff(glm::tvec3<double>(0.6, 0.6, 0.6));
